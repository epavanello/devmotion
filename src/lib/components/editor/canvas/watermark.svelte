...
<div
  class="pointer-events-none absolute top-3 right-3 z-9999 flex items-center gap-2 rounded-md bg-black/50 px-3 py-2 opacity-60 backdrop-blur-sm select-none"
>
  <div
